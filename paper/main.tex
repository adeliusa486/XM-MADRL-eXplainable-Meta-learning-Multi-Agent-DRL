...
packet-delivery ratio over a naive graph-only policy, and a constellation-based
classifier attains $84\%$ modulation-recognition accuracy. We report results
honestly, including where strong single-objective baselines retain a
communication-throughput edge.
...
is the most energy-efficient of the well-behaved policies.}
\label{fig:energy}
\end{figure}
...
and safety budgets, where XM-MADRL is strongest. Third, graph coordination
